...
CKPT_ARGS=(
   ...
   --load /root/changhun.lee/models/qwen3-1.7b-math-sft_slime_deepscaler_coef_0.1_normalize/
   --save /root/changhun.lee/models/qwen3-1.7b-math-sft_slime_deepscaler_coef_0.1_normalize/
   --save-interval 25
)
