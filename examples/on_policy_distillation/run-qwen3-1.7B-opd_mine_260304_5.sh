...
CKPT_ARGS=(
   ...
   --load /root/changhun.lee/models/qwen3-1.7b-math-sft_slime_deepscaler_coef_1.0_think_penalty/
   --save /root/changhun.lee/models/qwen3-1.7b-math-sft_slime_deepscaler_coef_1.0_think_penalty/
   --save-interval 15
)
