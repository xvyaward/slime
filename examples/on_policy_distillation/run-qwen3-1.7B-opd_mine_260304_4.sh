...
CKPT_ARGS=(
   ...
   --load /root/changhun.lee/models/qwen3-1.7b-math-sft_slime_deepscaler_coef_1.0_length_penalty/
   --save /root/changhun.lee/models/qwen3-1.7b-math-sft_slime_deepscaler_coef_1.0_length_penalty/
   --save-interval 15
)
...
GRPO_ARGS=(
   ...
   --entropy-coef 0.00
   --opd-length-penalty-coef 0.00001
)
