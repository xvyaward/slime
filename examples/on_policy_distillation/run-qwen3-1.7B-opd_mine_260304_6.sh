...
CKPT_ARGS=(
   --hf-checkpoint /root/changhun.lee/models/qwen3-1.7b-math-sft
   --ref-load /root/changhun.lee/models/qwen3-1.7b-math-sft_torch_dist
   --load /root/changhun.lee/models/qwen3-1.7b-math-sft_slime_deepscaler_coef_1.0_length_penalty_1e-3/
   --save /root/changhun.lee/models/qwen3-1.7b-math-sft_slime_deepscaler_coef_1.0_length_penalty_1e-3/
   --save-interval 15
)
