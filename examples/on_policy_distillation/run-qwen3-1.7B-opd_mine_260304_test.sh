...
CKPT_ARGS=(
   ...
   --load /root/changhun.lee/models/qwen3-1.7b-math-sft_slime_deepscaler_test/
   --save /root/changhun.lee/models/qwen3-1.7b-math-sft_slime_deepscaler_test/
   --save-interval 25
)

ROLLOUT_ARGS=(
   --prompt-data /root/changhun.lee/models/train_260131.parquet
   --input-key prompt
   --apply-chat-template
   --rollout-shuffle
   --num-rollout 300
