...
output_file = '/root/changhun.lee/models/OpenThoughts3_converted_260311.parquet'
...
def transform_with_instruction(row):
    ...
    prefix = "Solve the following problem step by step. The last line of your response should be of the form Answer: \\boxed{$Answer} where $Answer is the answer to the problem.\n\n"
